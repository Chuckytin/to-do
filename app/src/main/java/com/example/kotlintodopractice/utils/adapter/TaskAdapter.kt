    ...
    override fun onBindViewHolder(holder: TaskViewHolder, position: Int) {
        with(holder) {
            with(list[position]) {
                ...
                binding.todoTask.contentDescription = "Tarea: ${this.task}"
                binding.root.contentDescription = "Elemento de tarea ${position + 1} de ${list.size}"

                binding.editTask.contentDescription = "Editar tarea ${this.task}"
                binding.deleteTask.contentDescription = "Eliminar tarea ${this.task}"
